...
export const ASSET_REGISTRY: Readonly<Record<AssetId, AssetDefinition>> = {
  ...
  "electronic-scale": {
    ...
    ...ASSET_CALIBRATION["electronic-scale"],
  },
  screwdriver: {
    id: "screwdriver",
...
const SCENE_ASSETS: Readonly<Record<ScenarioId, readonly AssetInstance[]>> = {
  ...
  demo02: [
    { id: "s0-real", assetId: "box", objectId: "S0", role: "task-object", position: [-0.82, -0.23, 0.82], rotation: zero, scale: one },
  ...
  demo03: [
    ...
    { id: "food-a-real", assetId: "apple", objectId: "K1-FOOD-A", role: "task-object", position: [-0.75, -0.22, 0.82], rotation: zero, scale: one },
    { id: "scale-real", assetId: "electronic-scale", objectId: "ORDER-SCALE", role: "fixture", position: [0.61, -0.18, 0.78], rotation: zero, scale: one },
  ...
  demo04: [
    { id: "driver-real", assetId: "screwdriver", objectId: "ELECTRIC-DRIVER", role: "tool", position: [0.72, -0.38, 0.9], rotation: [0, 0, 0], scale: one },
  ...
  demo05: [
    { id: "a2-real", assetId: "pill-bottle", objectId: "A2", role: "task-object", position: [-0.28, 0.25, 0.72], rotation: zero, scale: one },
    { id: "a1-real", assetId: "box", objectId: "A1", role: "task-object", position: [-0.8, 0.25, 0.72], rotation: zero, scale: one },
  ...
  demo06: [
    { id: "g1-real", assetId: "apple", objectId: "G1", role: "task-object", position: [-0.78, -0.3, 0.84], rotation: zero, scale: one },
...
export function getSceneAssetInstances(sceneId: ScenarioId): readonly AssetInstance[] {
  const payloadId = PAYLOAD_INSTANCE_IDS[sceneId];
  return SCENE_ASSETS[sceneId].map((instance) =>
    instance.id === payloadId ? { ...instance, bodyName: "task_payload" as const } : instance,
  );
}
