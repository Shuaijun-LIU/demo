...
- 2026-08-13
  - What: 更深调色版完成并部署；背景为 `#d2d5d4`，棋盘为 `#456c8e / #7193ae`。52/52 单元、6/6 契约、6/6 Chromium、六份 MJCF 编译及穿透门通过；Pages run 31622169235 成功，公网 MuJoCo ready、0 页面错误、0 请求失败。
  - Next: 用户检查新版总览与公开页面；仅按明确反馈继续调色。
- 2026-08-13
  - What: 用户指出 Demo03/06 有悬空物体并要求主体背景接近黑色；坐标核算定位为称重显示器缺立柱、去核机横梁缺门架支撑，其余任务物体均有承载面。
  - Next: 先建立 AABB 支撑链回归测试，再补齐设备支撑并切换 `#252a2e` 背景。
- 2026-08-13
  - What: Demo03/06 支撑修复与近黑背景完成；新增三根支撑构成连续 AABB 接触链。54/54 单元、6/6 契约、6/6 Chromium、六份 MJCF 编译和穿模门通过；Pages run 31623647208 成功，公网两场 MuJoCo ready 且 XML 支撑齐全。
  - Next: 用户检查公开 Demo03/06 和新版总览；后续仅按明确反馈迭代。
